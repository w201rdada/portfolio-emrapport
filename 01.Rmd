...
As a data scientist working on this issue, I aim to help my collaborators be deliberate about how they present findings, given the politically charged nature of the national conversation about police misconduct and the complicated politics around the police unions and their relationships with the city government in Chicago. Journalists and activists should consider whether to use this data to inform stories and reports, or whether to publish interactive visualizations of the clusters in order to let the public explore the data on their own. As a data scientist working alongside these groups, it is part of my role to make sure collaborators understand the language processing methods well enough to make responsible use of the findings. I intend to take cues from groups like the Citizens Police Data Project and other public data projects on how to make the data as accessible as possible, which includes educating consumers of the data on how to use and understand data sets and visualizations that are made public.
