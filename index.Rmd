...
library(magrittr)
readLines('https://www.zotero.org/api/users/4664999/collections/KCNAVJ3B/items/top?start=0&limit=null&format=bibtex&itemKey=9NI269PT%2C5V8DWLZB&key=fn6ejgYQPGjjJ7PlvbI5Auu4&v=1') %>% writeLines('references.bib')
```
