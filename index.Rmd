...
library(magrittr)
readLines('https://www.zotero.org/api/users/4664999/items/top?start=0&limit=null&format=bibtex&itemKey=YCVH5Z8R&key=fn6ejgYQPGjjJ7PlvbI5Auu4&v=1') %>% writeLines('references.bib')
```
